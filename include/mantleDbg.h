...
typedef enum _GR_DBG_DATA_TYPE     GR_DBG_DATA_TYPE;
typedef enum _GR_DBG_DEVICE_OPTION GR_DBG_DEVICE_OPTION;
typedef enum _GR_DBG_GLOBAL_OPTION GR_DBG_GLOBAL_OPTION;
typedef enum _GR_DBG_MSG_FILTER    GR_DBG_MSG_FILTER;
typedef enum _GR_DBG_MSG_TYPE      GR_DBG_MSG_TYPE;
typedef enum _GR_DBG_OBJECT_TYPE   GR_DBG_OBJECT_TYPE;
...
// functions
MAGMA_FUNCTION(grDbgSetValidationLevel)(
	GR_DEVICE device,
	GR_ENUM   validationLevel
);
