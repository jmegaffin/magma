...
typedef enum _GR_WSI_WIN_IMAGE_STATE    GR_WSI_WIN_IMAGE_STATE;
typedef enum _GR_WSI_WIN_INFO_TYPE      GR_WSI_WIN_INFO_TYPE;
typedef enum _GR_WSI_WIN_PRESENT_MODE   GR_WSI_WIN_PRESENT_MODE;
typedef enum _GR_WSI_WIN_RESULT         GR_WSI_WIN_RESULT;
typedef enum _GR_WSI_WIN_ROTATION_ANGLE GR_WSI_WIN_ROTATION_ANGLE;

typedef enum _GR_WSI_WIN_EXTENDED_DISPLAY_FLAGS GR_WSI_WIN_EXTENDED_DISPLAY_FLAGS;
typedef enum _GR_WSI_WIN_IMAGE_CREATE_FLAGS     GR_WSI_WIN_IMAGE_CREATE_FLAGS;
typedef enum _GR_WSI_WIN_PRESENT_FLAGS          GR_WSI_WIN_PRESENT_FLAGS;
typedef enum _GR_WSI_WIN_PRESENT_SUPPORT_FLAGS  GR_WSI_WIN_PRESENT_SUPPORT_FLAGS;
