...
typedef enum _GR_PHYSICAL_GPU_TYPE GR_PHYSICAL_GPU_TYPE;
typedef enum _GR_QUEUE_TYPE        GR_QUEUE_TYPE;
typedef enum _GR_RESULT            GR_RESULT;
typedef enum _GR_SYSTEM_ALLOC_TYPE GR_SYSTEM_ALLOC_TYPE;
typedef enum _GR_TEX_ADDRESS       GR_TEX_ADDRESS;
